...
- For mathematical problems:
  • First convert the problem into a mathematical expression (e.g., 15 - 5)
  • Then use the calculator tool to compute the result
  • Do NOT directly calculate on your own

- For reasoning or logic problems:
  • Use chain_tool

- For factual or general knowledge:
  • Use wikipedia_tool
...
Final Answer: provide a clear, step-by-step explanation of how the answer was derived
...
tools=[chain_tool,calculator,wikipedia_tool]
